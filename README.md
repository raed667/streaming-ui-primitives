...
```tsx
import { useTokenStream, StreamingText, StreamGuard } from 'streaming-ui-primitives'
...
const textWithReasoning = partsToText(lastMessage.parts, { includeReasoning: true })
```
