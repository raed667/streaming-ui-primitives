...
export function App() {
  ...
  const isStreamingDebounced = useDebouncedStreaming(
    ...
    <div style={styles.root}>
      <div style={styles.header}>
        ...
        <p style={styles.subtitle}>
          Demonstrates <code>useMessageStream</code>,{" "}
          <code>fromUseChatStatus</code>, <code>StreamGuard</code>,{" "}
          <code>TypingIndicator</code>, <code>useDebouncedStreaming</code>
        </p>
      ...
      <div style={styles.chat}>
        ...
        <div style={styles.statusRow}>
          <span
            style={{ ...styles.statusBadge, ...statusColor(chatState.status) }}
          >
            {chatState.status}
          </span>
          {isStreamingDebounced && (
            <span style={styles.debouncedNote}>debounced: streaming</span>
          )}
        </div>
      </div>
